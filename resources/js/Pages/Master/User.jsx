...
export default function User({response = [], errors}){
        ...
        <>
            ...
            <div className={`${FormVisible ? 'hidden' : ''}`}>
                <div className="flex justify-end w-full px-6 py-2">
                    <button type="submit" onClick={FormShowed} className="w-[10%] h-12 rounded-lg text-xl font-extrabold shadow-2xl transform hover:scale-103 transition-all ease-in-out duration-300 tracking-wider bg-[#9AB78F] text-white hover:bg-[#8BA67E] ring-4 hover:ring-green-100/50">
            ...
            <div className={`${FormVisible ? '' : 'hidden'}`}>
                <div className="flex justify-start w-full px-6 py-2">
                    <button type="submit" className="w-[8%] h-10 rounded-lg text-lg font-extrabold shadow-2xl transform transition-all ease-in-out duration-300 tracking-wider bg-gray-500 text-white hover:bg-gray-800/50 ring-2 hover:ring-gray-400/50">
                        <span className="drop-shadow-md">
                            Back
                        </span>
                    </button>
